...
| \ | Sonar on / off: every nearby enemy, loot drop, breakable, devotion shrine (ruined shrines have their own sound; restored ones share the loot ping), dungeon entrance and other usable thing (doors, levers, riftgates, notes, graves) repeats its own ping, faster as it nears and panned to its side |
