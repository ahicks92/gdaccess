...
inline constexpr std::string_view kGlossaryObstacleTones = "obstacle tones";   // bank 2: a blocker the character walks round
inline constexpr std::string_view kGlossaryObstacleAhead = "obstacle ahead";
inline constexpr std::string_view kGlossaryObstacleRight = "obstacle right";
inline constexpr std::string_view kGlossaryObstacleBehind = "obstacle behind";
inline constexpr std::string_view kGlossaryObstacleLeft = "obstacle left";
