...
inline constexpr std::string_view kCompressionOn = "compression on";     // dev A/B of the sonar crowd compression (F12)
inline constexpr std::string_view kCompressionOff = "compression off";
