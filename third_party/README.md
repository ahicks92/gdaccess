...
| prism speech SDK | `prism-bin/prism-sdk-v0.18.1/` -- NOT committed (1.1 GB prebuilt) | prebuilt release v0.18.1 from the prism GitHub releases; the build delay-loads `prism.dll` from next to `gdaccess.dll` | MPL (see its LICENSES/) |
