...
ENTRIES = [
    ...
    ("ItemArtifactFormula_GetStaticClassInfo", "Game", r"GAME::ItemArtifactFormula::GetStaticClassInfo\(void\)"),
    ("ItemFactionBooster_GetStaticClassInfo", "Game", r"GAME::ItemFactionBooster::GetStaticClassInfo\(void\)"),
    ("ItemFactionWarrant_GetStaticClassInfo", "Game", r"GAME::ItemFactionWarrant::GetStaticClassInfo\(void\)"),
    ("ItemDifficultyUnlock_GetStaticClassInfo", "Game", r"GAME::ItemDifficultyUnlock::GetStaticClassInfo\(void\)"),
    ("ItemDevotionReset_GetStaticClassInfo", "Game", r"GAME::ItemDevotionReset::GetStaticClassInfo\(void\)"),
    ("ItemEnchantment_GetStaticClassInfo", "Game", r"GAME::ItemEnchantment::GetStaticClassInfo\(void\)"),
    ("Player_GetDiscoveredShrineUIDs", "Game", r"GAME::Player::GetDiscoveredShrineUIDs\(void\)"),
    ("Player_GetShrineUIDs", "Game", r"GAME::Player::GetShrineUIDs\(void\)"),
    ("Character_GetVisibleFaction", "Game", r"GAME::Character::GetVisibleFaction\(void\)"),
    ("GameEngine_GetFactionLevelValue", "Game", r"GAME::GameEngine::GetFactionLevelValue\("),
    ("Character_SubtractMoney", "Game", r"GAME::Character::SubtractMoney\(unsigned int\)"),
    ("Player_AddSack", "Game", r"GAME::Player::AddSack\(void\)"),
    ("GameEngine_AddTransferSack", "Game", r"GAME::GameEngine::AddTransferSack\(void\)"),
    ...
    ("Skill_IsTargetInLOS_Id", "Game", r"GAME::Skill::IsTargetInLOS\(class GAME::Character const & __ptr64,unsigned int\)"),
    ("Skill_IsTargetInLOS_Point", "Game", r"GAME::Skill::IsTargetInLOS\(class GAME::Character const & __ptr64,class GAME::WorldVec3 const"),
    ...
    # ---- quest completion + rewards (src/quest_rewards.cpp; docs/ingame-ui-survey.md "Quest reward") ----
    ("Quest2Task_Complete", "Game", r"GAME::Quest2Task::Complete\(bool\)"),
    ("Quest2Task_GetQuest", "Game", r"GAME::Quest2Task::GetQuest\(void\)"),
    ("Quest2Task_GetUid", "Game", r"GAME::Quest2Task::GetUid\(void\)"),
    ("Quest2_GetFileName", "Game", r"GAME::Quest2::GetFileName\(void\)"),
    ("Quest2Repository_CompleteQuestTask", "Game", r"GAME::Quest2Repository::CompleteQuestTask\("),
    ("ScriptableActionCollection_Execute", "Game", r"GAME::ScriptableActionCollection::Execute\("),
    ("ScriptableActionCollection_GetActions", "Game", r"GAME::ScriptableActionCollection::GetActions\(void\)"),
    ("ScriptableAction_IsReward", "Game", r"GAME::ScriptableAction::IsReward\(void\)"),
    ("ScriptableAction_GetType", "Game", r"GAME::ScriptableAction::GetType\(void\)"),
    ("GiveExperience_GetAmount", "Game", r"GAME::ScriptableAction_GiveExperience::GetAmount\(void\)"),
    ("GiveMoney_GetAmount", "Game", r"GAME::ScriptableAction_GiveMoney::GetAmount\(void\)"),
    ("GiveSkillPoint_GetAmount", "Game", r"GAME::ScriptableAction_GiveSkillPoint::GetAmount\(void\)"),
    ("GiveAttribPoint_GetAmount", "Game", r"GAME::ScriptableAction_GiveAttribPoint::GetAmount\(void\)"),
    ("GiveDevotion_GetAmount", "Game", r"GAME::ScriptableAction_GiveDevotion::GetAmount\(void\)"),
    ("GiveLevel_GetAmount", "Game", r"GAME::ScriptableAction_GiveLevel::GetAmount\(void\)"),
    ("GiveTribute_GetAmount", "Game", r"GAME::ScriptableAction_GiveTribute::GetAmount\(void\)"),
    ("GiveFaction_GetAmount", "Game", r"GAME::ScriptableAction_GiveFaction::GetAmount\(void\)"),
    ("GiveFaction_GetFactionTag", "Game", r"GAME::ScriptableAction_GiveFaction::GetFactionTag\(void\)"),
    ("GiveItem_GetNumItems", "Game", r"GAME::ScriptableAction_GiveItem::GetNumItems\(void\)"),
    ("GiveItem_GetInfoItem", "Game", r"GAME::ScriptableAction_GiveItem::GetInfoItem\("),
    ("GiveItem_GetCount", "Game", r"GAME::ScriptableAction_GiveItem::GetCount\(void\)"),
    ("FactionPack_GetFactionFromString", "Game", r"GAME::FactionPack::GetFactionFromString\("),
    ("GiveExperience_vftable", "Game", r"const GAME::ScriptableAction_GiveExperience::`vftable'$"),
    ("GiveMoney_vftable", "Game", r"const GAME::ScriptableAction_GiveMoney::`vftable'$"),
    ("GiveItem_vftable", "Game", r"const GAME::ScriptableAction_GiveItem::`vftable'$"),
    ("GiveRandomItem_vftable", "Game", r"const GAME::ScriptableAction_GiveRandomItem::`vftable'$"),
    ("GiveSkillPoint_vftable", "Game", r"const GAME::ScriptableAction_GiveSkillPoint::`vftable'$"),
    ("GiveAttribPoint_vftable", "Game", r"const GAME::ScriptableAction_GiveAttribPoint::`vftable'$"),
    ("GiveDevotion_vftable", "Game", r"const GAME::ScriptableAction_GiveDevotion::`vftable'$"),
    ("GiveLevel_vftable", "Game", r"const GAME::ScriptableAction_GiveLevel::`vftable'$"),
    ("GiveTribute_vftable", "Game", r"const GAME::ScriptableAction_GiveTribute::`vftable'$"),
    ...
    ("FactionPack_IsModified", "Game", r"GAME::FactionPack::IsModified\("),
    ("GameEngine_IsStartingFaction", "Game", r"GAME::GameEngine::IsStartingFaction\("),
    ("GameEngine_IsHiddenFaction", "Game", r"GAME::GameEngine::IsHiddenFaction\("),
    ...
    ("CombatAttributeAccumulator_GetTotalDefenseModifierType", "Game", r"GAME::CombatAttributeAccumulator::GetTotalDefenseModifierType\("),
    ("CombatDisplayAccumulator_ctor", "Game", r"GAME::CombatDisplayAccumulator::CombatDisplayAccumulator\(bool\)"),
    ("CombatDisplayAccumulator_dtor", "Game", r"GAME::CombatDisplayAccumulator::~CombatDisplayAccumulator\("),
    ("Character_GetAttachedItems", "Game", r"GAME::Character::GetAttachedItems\("),
    ("Character_GetCombatRegionChance", "Game", r"GAME::Character::GetCombatRegionChance\("),
    ("Item_GetDefenseAttributes", "Game", r"GAME::Item::GetDefenseAttributes\("),
    ("ItemEquipment_GetDefenseAttributes", "Game", r"GAME::ItemEquipment::GetDefenseAttributes\("),
    ("ItemArtifact_GetDefenseAttributes", "Game", r"GAME::ItemArtifact::GetDefenseAttributes\("),
    ("ItemRelic_GetDefenseAttributes", "Game", r"GAME::ItemRelic::GetDefenseAttributes\("),
    ("ItemEnchantment_GetDefenseAttributes", "Game", r"GAME::ItemEnchantment::GetDefenseAttributes\("),
    ...
    ("ItemArtifactFormula_GetArtifact", "Game", r"GAME::ItemArtifactFormula::GetArtifact\(void\)"),
    ("ItemArtifactFormula_GetCreationCost", "Game", r"GAME::ItemArtifactFormula::GetCreationCost\("),
    ("ItemArtifactFormula_GetMaximumCraftable", "Game", r"GAME::ItemArtifactFormula::GetMaximumCraftable\("),
    ("Item_GetDropClassification", "Game", r"GAME::Item::GetDropClassification\("),
    # the blacksmith's bonus blurb: the crafter's table record -> a LootRandomizerTable object -> its affix entries,
    # each rendered by the game's own AttributeRange text (what the window's crafter rollover shows)
    ("NpcCrafter_GetEnhancementTableName", "Game", r"GAME::NpcCrafter::GetEnhancementTableName\(void\)"),
    ("NpcCrafter_GetEnhancementTags", "Game", r"GAME::NpcCrafter::GetEnhancementTags\(void\)"),
    ("ObjectManager_CreateObjectFromFile", "Engine", r"GAME::ObjectManager::CreateObjectFromFile\("),
    ("LootRandomizerTable_GetAllEntries", "Game", r"GAME::LootRandomizerTable::GetAllEntries\("),
    ("LootRandomizerTable_GetStaticClassInfo", "Game", r"GAME::LootRandomizerTable::GetStaticClassInfo\("),
    ("AttributeRange_ctor", "Game", r"GAME::AttributeRange::AttributeRange\(void\)"),
    ("AttributeRange_dtor", "Game", r"GAME::AttributeRange::~AttributeRange\(void\)"),
    ("AttributeRange_LoadAffix", "Game", r"GAME::AttributeRange::LoadAffix\("),
    ("AttributeRange_CreateText", "Game", r"GAME::AttributeRange::CreateText\("),
    ("Player_GiveArtifactToCharacter", "Game", r"GAME::Player::GiveArtifactToCharacter\("),   # hooked: the crafted item landing in the bag
    ("ItemArtifactFormula_GetReagentBaseId", "Game", r"GAME::ItemArtifactFormula::GetReagentBaseId\(void\)"),
    ("ItemArtifactFormula_GetReagentBaseDisplayName", "Game", r"GAME::ItemArtifactFormula::GetReagentBaseDisplayName\(bool\)"),
    ("ItemArtifactFormula_GetReagentBaseQuantityForFormula", "Game", r"GAME::ItemArtifactFormula::GetReagentBaseQuantityForFormula\(void\)"),
    ("ItemArtifactFormula_GetReagentBaseCount", "Game", r"GAME::ItemArtifactFormula::GetReagentBaseCount\(class GAME::Character const"),
    ("ItemArtifactFormula_GetReagent1Id", "Game", r"GAME::ItemArtifactFormula::GetReagent1Id\(void\)"),
    ("ItemArtifactFormula_GetReagent1DisplayName", "Game", r"GAME::ItemArtifactFormula::GetReagent1DisplayName\(bool\)"),
    ("ItemArtifactFormula_GetReagent1QuantityForFormula", "Game", r"GAME::ItemArtifactFormula::GetReagent1QuantityForFormula\(void\)"),
    ("ItemArtifactFormula_GetReagent1Count", "Game", r"GAME::ItemArtifactFormula::GetReagent1Count\(class GAME::Character const"),
    ("ItemArtifactFormula_GetReagent2Id", "Game", r"GAME::ItemArtifactFormula::GetReagent2Id\(void\)"),
    ("ItemArtifactFormula_GetReagent2DisplayName", "Game", r"GAME::ItemArtifactFormula::GetReagent2DisplayName\(bool\)"),
    ("ItemArtifactFormula_GetReagent2QuantityForFormula", "Game", r"GAME::ItemArtifactFormula::GetReagent2QuantityForFormula\(void\)"),
    ("ItemArtifactFormula_GetReagent2Count", "Game", r"GAME::ItemArtifactFormula::GetReagent2Count\(class GAME::Character const"),
    ("ItemArtifactFormula_GetReagent3Id", "Game", r"GAME::ItemArtifactFormula::GetReagent3Id\(void\)"),
    ("ItemArtifactFormula_GetReagent3DisplayName", "Game", r"GAME::ItemArtifactFormula::GetReagent3DisplayName\(bool\)"),
    ("ItemArtifactFormula_GetReagent3QuantityForFormula", "Game", r"GAME::ItemArtifactFormula::GetReagent3QuantityForFormula\(void\)"),
    ("ItemArtifactFormula_GetReagent3Count", "Game", r"GAME::ItemArtifactFormula::GetReagent3Count\(class GAME::Character const"),
    ("ItemArtifactFormula_GetReagent4Id", "Game", r"GAME::ItemArtifactFormula::GetReagent4Id\(void\)"),
    ("ItemArtifactFormula_GetReagent4DisplayName", "Game", r"GAME::ItemArtifactFormula::GetReagent4DisplayName\(bool\)"),
    ("ItemArtifactFormula_GetReagent4QuantityForFormula", "Game", r"GAME::ItemArtifactFormula::GetReagent4QuantityForFormula\(void\)"),
    ("ItemArtifactFormula_GetReagent4Count", "Game", r"GAME::ItemArtifactFormula::GetReagent4Count\(class GAME::Character const"),
    ("ItemArtifactFormula_GetReagent5Id", "Game", r"GAME::ItemArtifactFormula::GetReagent5Id\(void\)"),
    ("ItemArtifactFormula_GetReagent5DisplayName", "Game", r"GAME::ItemArtifactFormula::GetReagent5DisplayName\(bool\)"),
    ("ItemArtifactFormula_GetReagent5QuantityForFormula", "Game", r"GAME::ItemArtifactFormula::GetReagent5QuantityForFormula\(void\)"),
    ("ItemArtifactFormula_GetReagent5Count", "Game", r"GAME::ItemArtifactFormula::GetReagent5Count\(class GAME::Character const"),
    ("ItemArtifactFormula_GetReagent6Id", "Game", r"GAME::ItemArtifactFormula::GetReagent6Id\(void\)"),
    ("ItemArtifactFormula_GetReagent6DisplayName", "Game", r"GAME::ItemArtifactFormula::GetReagent6DisplayName\(bool\)"),
    ("ItemArtifactFormula_GetReagent6QuantityForFormula", "Game", r"GAME::ItemArtifactFormula::GetReagent6QuantityForFormula\(void\)"),
    ("ItemArtifactFormula_GetReagent6Count", "Game", r"GAME::ItemArtifactFormula::GetReagent6Count\(class GAME::Character const"),
